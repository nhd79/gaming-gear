      ...
      <div class="col-lg-9">
        ...
        <div class="card mt-4">
          ...
          if(isset($_GET["masp"]))
          {
            ...
            $bang=$db->query("select * from sanpham where id=".$masp);
            foreach($bang as $sanpham)
            {
              echo "<img class='card-img-top img-fluid' src='images/".$sanpham[4]."' alt='Sản phẩm'>
              <div class='card-body'>
                <h3 class='card-title'>".$sanpham[2]."</h3>
                <h4 style='color:red;'>".number_format($sanpham[3])." VND &nbsp;
                ...
                <span class='text-warning'>".$sanpham[10]."</span>
              </div>
              ";
            }
          }
